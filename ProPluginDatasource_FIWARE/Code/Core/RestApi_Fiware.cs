...
{
    public static class RestApi_Fiware
    {
        private static readonly string m_ModuleName = "RestApi_Fiware";
        ...
        private static async Task<List<string>> ReadSettingsFromJsonFileAsync(string settingsPath)
        {
            try
            {
        ...
        public static async Task<List<string>> ReadEntityTypesFromRestApiAsync(string datasourcePath)
        {
            try
            {
            ...
            {
                await Fusion.m_Messages.PushAsyncEx(ex, m_ModuleName, "ReadEntityTypesFromRestApiAsync");
                return null;
            }
        }

        private static async Task<List<string>> ReadSettingsFromJsonObjectAsync(JObject oJObjectSettings, string settingsPath)
        {
            try
            {
                string msg = "";
                ...
                List<string> listEntityTypes = new List<string>();
                if (oJTokenVals != null)
                {
        ...
        private static async Task<object> GetJsonFromRestApiAsync(string apiUrl)
        {
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    {
                        // Handle unsuccessful response (400 Bad Request, etc.)
        ...
        public static async Task<JArray> GetEntitiesFromRestApiAsync(string datasourcePath, string entityType)
        {
            try
            {
        ...
        public static async Task StopUpdateAsync()
        {
            try
            {
        ...
        public static async Task StartUpdateAsync(string entityType)
        {
            try
            {
                switch (entityType)
