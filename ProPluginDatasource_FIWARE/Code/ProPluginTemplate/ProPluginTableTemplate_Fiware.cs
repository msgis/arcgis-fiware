...
namespace msGIS.ProPluginDatasource_FIWARE
{
    ...
    public class ProPluginTableTemplate_Fiware : PluginTableTemplate, IDisposable, IPluginRowProvider
    {
        ...
        //     class.
        public ProPluginTableTemplate_Fiware(string path, string name, SpatialReference sr = null) : base()
        {
            _path = path;
            _name = name;
        ...
        private PluginCursorTemplate SearchInternal(QueryFilter qf)
        {
            ...
            return new ProPluginCursorTemplate_Fiware(this,
                                            oids,
                                            columns,
