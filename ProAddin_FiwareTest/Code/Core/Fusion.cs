...
namespace msGIS.ProApp_FiwareTest
{
    internal static class Fusion
    {
        ...
        internal const string m_StateID_Main = "msGIS_FiwareTest_StateID_Main";
        internal const string m_StateID_Menu = "msGIS_FiwareTest_StateID_Menu";
        internal const string m_StateID_Map = "msGIS_FiwareTest_StateID_Map";

        internal const string m_StateID_TS_EntityTypes = "msGIS_FiwareTest_StateID_EntityTypes";
        ...
        internal const string m_ButtonID_ProjectInfo = "msGIS_FiwareTest_ButtonID_ProjectInfo";

        internal const string m_DockpaneID_EntityTypes = "msGIS_FiwareTest_DockpaneID_EntityTypes";
        internal const string m_ButtonID_TS_EntityTypesBoard = "msGIS_FiwareTest_ButtonID_TS_EntityTypes";
