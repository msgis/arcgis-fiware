...
echo off
echo =====================================================================================================
echo Make ProApp_FiwareTest_3x
echo
echo Authors:
...
echo on > %MakeInfo%
echo ----------------------------------------------------------------------------------------------------->> %MakeInfo%
echo Start make ProApp_FiwareTest_3x on %date% %time% by %username% on %computername%>> %MakeInfo%
echo ----------------------------------------------------------------------------------------------------->> %MakeInfo%
goto :Main
...
rem -----------------------------------------------------------------------------------------------------
cd ..\ProPluginDatasource_EntityFile
call :Delete_ObjBin
if "%BuildProPluginDatasource_EntityFile%" == 1 (
...
rem -----------------------------------------------------------------------------------------------------
REM ProApp_FiwareTest_3x
rem -----------------------------------------------------------------------------------------------------
MsBuild.exe msGIS.ProApp_FiwareTest_3x.csproj -t:Clean >> %MakeInfo%
rem devenv.exe ProApp_FiwareTest_3x.sln /rebuild Release /out %MakeInfo%
MSBuild.exe ProApp_FiwareTest_3x.sln -m -t:restore -property:Configuration=Release >> %MakeInfo%
MSBuild.exe ProApp_FiwareTest_3x.sln -m -t:rebuild -property:Configuration=Release >> %MakeInfo%
