...
echo off
echo =====================================================================================================
echo Make ProApp_FiwareSummit_3_3
echo
echo Authors:
...
echo on > %MakeInfo%
echo ----------------------------------------------------------------------------------------------------->> %MakeInfo%
echo Start make ProApp_FiwareSummit_3_3 on %date% %time% by %username% on %computername%>> %MakeInfo%
echo ----------------------------------------------------------------------------------------------------->> %MakeInfo%
goto :Main
...
rem -----------------------------------------------------------------------------------------------------
REM ProApp_FiwareSummit_3_3
rem -----------------------------------------------------------------------------------------------------
MsBuild.exe msGIS.ProApp_FiwareSummit_3_3.csproj -t:Clean >> %MakeInfo%
rem devenv.exe ProApp_FiwareSummit_3_3.sln /rebuild Release /out %MakeInfo%
MSBuild.exe ProApp_FiwareSummit_3_3.sln -m -t:restore -property:Configuration=Release >> %MakeInfo%
MSBuild.exe ProApp_FiwareSummit_3_3.sln -m -t:rebuild -property:Configuration=Release >> %MakeInfo%
