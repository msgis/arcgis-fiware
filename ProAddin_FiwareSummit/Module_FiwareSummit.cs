...
namespace msGIS.ProApp_FiwareSummit
{
    ...
    {
        private readonly string m_ModuleName = "Module_FiwareSummit";
        ...
        private static Module_FiwareSummit _this = null;

        /// <summary>
        /// Retrieve the singleton instance to this module here
        /// </summary>
        public static Module_FiwareSummit Current => _this ??= (Module_FiwareSummit)FrameworkApplication.FindModule("msGIS_FiwareSummit_ModuleID_Main");
        ...
        private async Task InitAsync()
        {
            try
            {
                ...
                await Fusion.m_General.SetAddInInfoAsync(Fusion.m_AppropriateBaseVersion);
