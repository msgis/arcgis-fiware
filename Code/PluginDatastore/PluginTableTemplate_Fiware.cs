...
namespace msGIS.ProApp_FiwareSummit
{
    ...
    internal class PluginTableTemplate_Fiware : PluginTableTemplate
    {
        // Summary:
        //     Initializes a new instance of the ArcGIS.Core.Data.PluginDatastore.PluginTableTemplate
        //     class.
        internal PluginTableTemplate_Fiware() : base()
        {
        }
        ...
        public override PluginCursorTemplate_Fiware Search(QueryFilter queryFilter)
        {
            throw new NotImplementedException();
        }
        ...
        public override PluginCursorTemplate_Fiware Search(SpatialQueryFilter spatialQueryFilter)
        {
            throw new NotImplementedException();
        }
    }
