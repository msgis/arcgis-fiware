...
namespace msGIS.ProApp_FiwareSummit
{
    ...
    internal class PluginDatasourceTemplate_Fiware : PluginDatasourceTemplate
    {
        // Initializes a new instance of the ArcGIS.Core.Data.PluginDatastore.PluginDatasourceTemplate class.
        internal PluginDatasourceTemplate_Fiware() : base()
        {
        ...
        {
            // throw new NotImplementedException();
            PluginTableTemplate_Fiware pluginTableTemplate_Fiware = new PluginTableTemplate_Fiware();
            return pluginTableTemplate_Fiware;
        }
